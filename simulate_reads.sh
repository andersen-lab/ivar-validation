...
samtools mpileup -d 300000 -A -Q 0 -F 0 data/ZI-merge-27_a.sorted.bam | ivar consensus -p data/ZI-merge-27a.consensus -q 0 -t 0
samtools mpileup -d 300000 -A -Q 0 -F 0 data/ZI-merge-27_a.sorted.bam | ivar consensus -p data/ZI-merge-27a.25.consensus -q 0 -t 0.25
samtools mpileup -d 300000 -A -Q 0 -F 0 data/ZI-merge-27_a.sorted.bam | ivar consensus -p data/ZI-merge-27a.50.consensus -q 0 -t 0.50
samtools mpileup -d 300000 -A -Q 0 -F 0 data/ZI-merge-27_a.sorted.bam | ivar consensus -p data/ZI-merge-27a.90.consensus -q 0 -t 0.90

samtools mpileup -d 600000 -A -Q 0 -F 0 data/ZI-merge-26_a.sorted.bam | ivar consensus -p data/ZI-merge-26a.consensus -q 0 -t 0
samtools mpileup -d 600000 -A -Q 0 -F 0 data/ZI-merge-26_a.sorted.bam | ivar consensus -p data/ZI-merge-26a.25.consensus -q 0 -t 0.25
samtools mpileup -d 600000 -A -Q 0 -F 0 data/ZI-merge-26_a.sorted.bam | ivar consensus -p data/ZI-merge-26a.50.consensus -q 0 -t 0.50
samtools mpileup -d 600000 -A -Q 0 -F 0 data/ZI-merge-26_a.sorted.bam | ivar consensus -p data/ZI-merge-26a.90.consensus -q 0 -t 0.90
